...
export const projects: Project[] = [
  {
    ...
    title:
      "Agile Weiter-Entwicklung einer B2B Charging Solutions zwischen E-Mobility und Smart Energy",
    industry: "E-Mobility",
    ...
    description: `Als Product Owner habe ich die Migration der Charging Infratruktur einer der größten Automotive-Premiummarken von einem Backend zum anderen analysiert, Feature Deltas abgeleitet, Features geplant, eine Raodmap entwickelt und mit den anderen Stakeholdern abgestimmt. Außerdem wurden als Teil der Planung der Implementierung zentrale Architekturanpassungen mit bis zu 7 Teams abgestimmt und durchgesetzt. Mit dem mir zur Verfügung stehenden Entwicklerteam wurde die priorisierte Featureliste umgesetzt. Regelmäßige, firmenweite Season Plannings wurden durchgeführt und anhand von OKRs (Objectives and Key Results) die Themen geplant.`,
  },
  {
    customer: "Automotive OEM",
    title:
      "Entwicklung eines Prozesssteuerungstools für die WLTP- und NEFZ-Fahrzeugzertifizierung",
    industry: "Automotive",
    clientSize: ClientSize.Corporate,
    serviceType: ServiceType.Consulting,
    taskTypes: [
